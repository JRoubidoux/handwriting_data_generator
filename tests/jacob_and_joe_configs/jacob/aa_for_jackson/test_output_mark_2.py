...
if __name__ == "__main__":
    path_to_config = r"handwriting_data_generator\tests\jacob_and_joe_configs\jacob\aa_for_jackson\birthplace_mark_2_config.yaml"
    ...
    merged_image_transforms = [A.Rotate(limit=1.3, p=1.0)] #might change rotation
    ...
    merged_images_output_path = r"handwriting_data_generator\tests\jacob_and_joe_configs\jacob\merged_image_output"
