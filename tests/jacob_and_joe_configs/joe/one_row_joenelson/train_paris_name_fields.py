...
if __name__ == "__main__":
    ...
    path_to_config = "/grphome/fslg_census/nobackup/archive/projects/paris_french_census/one_row_joenelson/paris_data_generator_name_config.yaml"
