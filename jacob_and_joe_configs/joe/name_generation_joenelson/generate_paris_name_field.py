...
sys.path.append(r"../../../common_tools/handwriting_data_generator/branches/main/RLL_handwriting_data_generator/src/mark_2")

import data_generator as dg
from custom_transforms import ConvertDataType, LightenOrDarkenImage, lightenOrDarkenPartsOfWord

if __name__ == "__main__":
    path_to_config = r"./paris_data_generator_name_config.yaml"
    ...
    merged_images_output_path = r"./merged_word_images"
