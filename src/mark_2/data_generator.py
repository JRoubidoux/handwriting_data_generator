...
class fontObjectManagerGivenVocabulary(fontObjectManager):
    ...
    def determine_fonts_for_vocabularly(self, vocabulary: list) -> dict:
        """
...
class fontLetterPlotDictionaryInstantiator():
    ...
    """
    @staticmethod
    def get_font_letter_plot_dictionary(font_object_manager_given_vocab: fontObjectManagerGivenVocabulary, vocabulary: list) -> dict:
        """
...
class mergeWordImagesOnBaseImage():
    ...
    def get_font_object_manager_given_vocabulary(self, config: dict) -> fontObjectManagerGivenVocabulary:
        """
