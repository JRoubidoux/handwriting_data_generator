...
if __name__ == '__main__':
    ...
    occupations_in = '/grphome/fslg_census/nobackup/archive/common_tools/handwriting_data_generator/branches/init/RLL_handwriting_data_generator/vocabularies_of_interest/occupations_temp.txt'
    vocab_manager = vocabManager(current_vocabularies_file_path)
    vocab_manager.load_in_data_and_write_to_vocab("occupation", occupations_in)